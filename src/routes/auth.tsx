...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Entre ou crie sua conta para acompanhar sua leitura bíblica." },
      { property: "og:title", content: "Entrar — Bible Tracker" },
      { property: "og:description", content: "Entre ou crie sua conta para acompanhar sua leitura bíblica." },
    ],
  }),
  component: AuthPage,
});
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-8">
      <div className="w-full max-w-sm">
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <h1 className="mt-3 text-2xl font-bold">Bible Tracker</h1>
          <p className="text-sm text-muted-foreground">Sua jornada de leitura começa aqui</p>
        </div>
